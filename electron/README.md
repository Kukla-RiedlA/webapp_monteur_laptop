...
7. Montagebericht offline: **„Speichern (nur Daten)“** speichert den Zwischenstand in der lokalen SQLite (`protocol_drafts`, je FN) — **keine** leere `montagebericht.json` im Dienstreise-Ordner. Nach **Auftrag erledigt** ist diese JSON-Zeile festgeschrieben (`frozen`).
