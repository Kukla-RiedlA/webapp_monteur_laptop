  ...
  var FORMS = {
    ...
    montagebericht: {
      ...
      map: [
        ...
        { sel: '#btnMontageberichtStickySave', en: 'Save' },
        { sel: '#btnMontageberichtStickySave', attr: 'title', en: 'Save data only' },
        { sel: '#btnMontageberichtStickyPdf', en: 'PDF' },
        ...
        { sel: '[data-mb-img="insert"]', attr: 'aria', en: 'Insert image' },
        { sel: '[data-mb-img="from-project"]', attr: 'title', en: 'Photos from the project folder (mobile PWA)' },
        { sel: '[data-mb-img="from-project"]', attr: 'aria', en: 'Project photo' },
        ...
        { sel: '[data-mb-img="rotate"]', attr: 'aria', en: 'Rotate' },
        { sel: '[data-mb-cluster="text"] .toolbar-cluster-label', en: 'Text' },
        { sel: '[data-mb-cluster="image"] .toolbar-cluster-label', en: 'Image' },
        { sel: '[data-mb-cluster="draw"] .toolbar-cluster-label', en: 'Draw' },
        { sel: '[data-mb-img="remove"]', attr: 'title', en: 'Remove image' },
        { sel: '[data-mb-img="remove"]', attr: 'aria', en: 'Remove' },
        { sel: '[data-mb-draw="move"]', attr: 'title', en: 'Grab image and move it in the text' },
        { sel: '[data-mb-draw="move"]', attr: 'aria', en: 'Move image' },
        { sel: '[data-mb-draw="line"]', attr: 'title', en: 'Line on the image' },
        { sel: '[data-mb-draw="line"]', attr: 'aria', en: 'Line' },
        { sel: '[data-mb-draw="free"]', attr: 'title', en: 'Freehand on the image' },
        { sel: '[data-mb-draw="free"]', attr: 'aria', en: 'Freehand' },
        { sel: '[data-mb-draw="rect"]', attr: 'title', en: 'Rectangle on the image' },
        { sel: '[data-mb-draw="rect"]', attr: 'aria', en: 'Rectangle' },
        { sel: '[data-mb-draw="circle"]', attr: 'title', en: 'Circle on the image' },
        { sel: '[data-mb-draw="circle"]', attr: 'aria', en: 'Circle' },
        { sel: '[data-mb-draw="erase"]', attr: 'title', en: 'Erase drawing' },
        { sel: '[data-mb-draw="erase"]', attr: 'aria', en: 'Eraser' },
        { sel: '[data-mb-draw-act="undo"]', attr: 'title', en: 'Undo last drawing' },
        { sel: '[data-mb-draw-act="undo"]', attr: 'aria', en: 'Undo' },
        { sel: '#mbDrawStroke', attr: 'title', en: 'Stroke width' },
        { sel: '#mbDrawColor', attr: 'title', en: 'Draw color' },
        { sel: '#mbV2Sec4Title', en: 'Save' },
        { sel: '#btnMontageberichtSaveJson', en: 'Save' },
        { sel: '#btnMontageberichtSaveJson', attr: 'title', en: 'Save data only' },
        { sel: '#btnMontageberichtSavePdf', en: 'PDF' },
